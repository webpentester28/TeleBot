...
if base:sismember(TD_ID .. "Gp:" .. chat, "Del:VoiceEnglish") then
    if base:sismember(TD_ID .. "Gp2:" .. chat, "Telebotlang") then
        VoiceEnglish = "Aᴄᴛɪᴠᴇ |☑️|"
    else
        VoiceEnglish = "فعال |☑️|"
    end
else
    if base:sismember(TD_ID .. "Gp2:" .. chat, "Telebotlang") then
        VoiceEnglish = "Dɪsᴀʙʟᴇᴅ |⬜️|"
    else
        VoiceEnglish = "غیرفعال |⬜️|"
    end
end		
...
if base:sismember(TD_ID .. "Gp:" .. chat, "Del:Android") then
    if base:sismember(TD_ID .. "Gp2:" .. chat, "Telebotlang") then
        Android = "Aᴄᴛɪᴠᴇ |☑️|"
    else
        Android = "فعال |☑️|"
